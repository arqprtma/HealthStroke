        ...
        <div class="container mx-auto">
            ...
            <div class="content relative top-[50px] lg:top-[50px] w-[80%] mx-auto">
                ...
                @if ($penanganan->video)
                    ...
                    <iframe class="w-[100%] lg:h-[50vw] h-[300px] mt-5 mb-10" src="https://www.youtube.com/embed/{{ $penanganan->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
                    </iframe>
                @endif
                ...
                <div class="text-center mt-7 pb-10">
                    ...
                    <a href="{{ route('add-log-penanganan', ['id' => $penanganan->id_penanganan]) }}">
                        ...
                        @if($log_treatment == $trigerpenanganan->jumlah )
                        <script>
