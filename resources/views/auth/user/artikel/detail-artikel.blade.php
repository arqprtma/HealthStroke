...
<head>
    ...
    <title>Setting Profile - Health Stroke</title>
</head>
...
<body class="bg-[#F8F8FF]">
    <div class="container mx-auto">
        ...
        <div class="content relative top-[50px] lg:top-[50px] w-[80%] mx-auto">
            ...
            <h2 class="mt-5 mb-5">Tanda dan Gejala</h2>
            <img src="images/artikel1.png" alt="" class="w-[100%] object-fit mx-auto">
            <h2 class="mt-5 mb-5 text-sm lg:text-lg">Deskripsi : </h2>
            <p class=" mx-auto text-sm lg:text-lg">Latihan kekuatan kaki dengan mengangkat kaki saat duduk dikursi.</p>
