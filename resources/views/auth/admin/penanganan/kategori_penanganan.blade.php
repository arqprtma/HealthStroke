...
<body class="bg-[#F8F8FF]">
    <div class="flex items-center justify-around bg-auto bg-cover bg-left-top bg-no-repeat -mt-4 lg:h-[356px] h-[300px]" id="bg-blub">
        <div class="px-5">
            ...
            <h2 class="text-left font-bold text-black lg:text-xl text-sm m-0">Tambah Penanganan Treatment</h2>
        </div>
        <div class="px-5">
    ...
    <form method="post" action="{{ route('admin.penanganan.kategori.store') }}" class="container lg:w-[80%] mx-auto pb-7 px-5 lg:-mt-20 -mt-24">
        @csrf
